...
for index,datainonerow in dels.iterrows(): #rows with delivery process
    ...
    #delList = [datainonerow.iloc[4],datainonerow.iloc[3],]
    ...
    # print(datainonerow.iloc[4],datainonerow.iloc[3],datainonerow.iloc[5])
    ...
    for datainonerow1 in range(0,len(filter_data_df_forward)):
        ...
        for index, datainonerow2 in filter_data_df_treat.iterrows():
            ...
            for index, datainonerow3 in filter_data_df_cond.iterrows():
                ...
                for index, datainonerow4 in filter_data_df_sor.iterrows():
